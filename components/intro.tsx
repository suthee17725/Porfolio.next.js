...
import Hero from "@/public/HeroV2.png";
...
export default function Intro() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        <span className="font-bold">Hello,I'm Chen.</span> I'm a{" "}
        <span className="font-bold">Junior full stack developer.</span> I enjoy
        building <span className="italice">website</span>. My focus is{" "}
        <span className="underline">React (Next.js,Vue.js,React.js)</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/suthee-namsiri40/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          ...
          href="https://github.com/suthee17725"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
